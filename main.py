...
# Feature Extraction using TF-IDF (Identify important keywords)
vectorizer = TfidfVectorizer(min_df=1)  # Allow even rare words
X = vectorizer.fit_transform(preprocessed_docs)

# Clustering using K-Means (Manipulate Document Cluster patterns)
...
def check():
    ...
    return render_template("check.html", msg=msg,act=act,dfile=dfile,differences=differences,text1=text1)
